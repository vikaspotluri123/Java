...
public class Deck
{
	...
	public int size()
	{
		return myCards.length;	// TODO: Implement this method correctly.  COMPLETE
	}
	...
	public boolean isEmpty()
	{
		if (size() == 0)
			return true;
		return false; // TODO: Implement this method correctly.COMPLETE
	}
	...
	public String toString()
	{
		...
		for (Card x : myCards)
			s = s + x + " ";
		return s;
		// TODO: Implement this method correctly. COMPLETE	
	}
	...
	public Card[] getCards(int first, int last)
	{
		...
		return subset;		// TODO: Implement this method correctly. COMPLETE!
	}
	...
	{
		return getCards(0, this.size()-1);		// TODO: Implement this method correctly. COMPLETE!
	}
