...
public class bank_forgot extends JFrame
{
	private static final long serialVersionUID = 4498657757971570078L;
	private ArrayList<Person> people = new ArrayList<Person>();
	JLabel username = new JLabel("What is your email address?");
	JTextField user = new JTextField(15);
	JButton submit = new JButton("Submit");
	JPanel panel = new JPanel();
	public bank_forgot(ArrayList<Person> peoplse)
	{
	...
	public void searchAndDestroy()
	{
		...
		for(int i = 0 ; i < people.size(); i++)
		{
			...
			{
				bank_resetPass bank = new bank_resetPass(people,people.get(i).getUsername());
